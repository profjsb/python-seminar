...
from __future__ import print_function   # let's start getting used print as a function!
import math
...
for i in range(8): print("{:.4e} ".format(abs(b.next() - math.pi)/math.pi),end=" ")
a = pi_series()
print("\n" + "-"*30)
print("\nfractional accuracy first 8 in un-accelerated series....:")
for i in range(8): print("{:.4e} ".format(abs(a.next() - math.pi)/math.pi),end=" ")
